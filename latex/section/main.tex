...
\begin{abstract}
%\boldmath
Este artículo presenta la creación de una biblioteca en C para Odometría. Creada y optimizada para ser aplicada en la estimación de la posición de un drone con procesadores de bajos recursos como lo son los Arduino además de compararla con otras bibliotecas existentes. Los elementos matemáticos son descritos y estructurados computacionalmente. La conversión entre estos tipos de datos es mostrada. Se explica también  la forma de uso en las diversas partes de un sistema implementado sobre drones y se muestran conclusiones.
\end{abstract}
